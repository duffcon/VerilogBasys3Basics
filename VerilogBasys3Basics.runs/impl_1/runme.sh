...
HD_PWD='C:/Users/conne/OneDrive/Code/Verilog/VerilogBasys3Basics/VerilogBasys3Basics.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SegmentDisplay.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SegmentDisplay.tcl -notrace
